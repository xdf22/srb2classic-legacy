...
static CV_PossibleValue_t fov_cons_t[] = {{60, "MIN"}, {179, "MAX"}, {0, NULL}};
...
consvar_t cv_fov = {"fov", "90", CV_CALL, fov_cons_t, Fov_OnChange, 0, NULL, NULL, 0, 0, NULL};
...
void R_ExecuteSetViewSize(void)
{
	...
	fov = FixedAngle(((cv_fov.value)*FRACUNIT)/2) + ANGLE_90;
