...
static openmpt_module *openmpt_mhandle;
#endif
...
static char music_stack_nextmusname[7];
static boolean music_stack_noposition;
static UINT32 music_stack_fadeout;
static UINT32 music_stack_fadein;
